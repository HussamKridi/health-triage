  ...
  return (
    <>
      <section className="space-y-4">
        <Badge className="rounded-full px-4 py-1.5">Quick Check-Up</Badge>
      ...
      <Card className="border-slate-200/80 bg-white/95 shadow-sm">
        <CardHeader>
          ...
          <CardTitle className="pt-3 text-xl">Quick Check-Up</CardTitle>
        ...
        <CardContent>
          <TriageForm
            ...
            disabledMessage="Complete the patient profile once, then use Quick Check-Up any time for fast session entry."
            onSubmit={handleQuickCheck}
            isSubmitting={isSubmittingTriage}
            submitLabel="Run Quick Check-Up"
            footer={
